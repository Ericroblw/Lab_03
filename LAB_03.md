...
![Verificación de tablas clave en AdventureWorksLT](img/AdventureWorksLT.png)
...
![Objeto JSON simple](img/Object-JSON.png)
...
![JSON anidado con categoría](img/JSON-anidado.png)
...
![Función de ranking con CTE](img/Funcion-CTE.png)
...
![Productos clasificados exportados a JSON con ROOT](img/Productos-JSON-CTE.png)
...
![Parseo de array JSON a filas con OPENJSON](img/JSON-filas.png)
...
![Unión de datos relacionales con OPENJSON](img/Unir-JSON.png)
